			...
			<div class="row">
				<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 full_width">
					<div class="btc_tittle_left_heading">
						<h1>{{ $data[0]->rental->nama_rental }}</h1>
					</div>
				</div>
				<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 full_width">
                                    ...
                                    <div
                                        ...
                                        <div class="x_car_access_right_price_main_box_inner_left_wrapper">
                                            <div class="x_car_access_right_price_img_wrapper">
                                                <img src="{{ asset('images/mobil/'.$item->foto_mobil) }}" class="img-thumbnail" alt="g1_img">
                                            </div>
                                            <div class="x_car_access_right_price_img_cont_wrapper">
                                                <h3>{{ $item->nama_mobil }}</h3>
                                                <p>{{ $item->plat_mobil }}<br><b>Seat:</b> {{ $item->kapasitas_mobil }} Seat, <b>Transmission:</b> {{ $item->transmisi_mobil }}</p>
                                            </div>
                                        </div>
                                        <div class="x_car_access_right_price_main_box_inner_right_wrapper">
                                            {{-- <div class="x_car_acc_price_dollar_wrapper">
                                                <h3>{{ App\Helpers\Format::formatRupiah($item->harga_sewa_mobil)*App\Helpers\Format::days($item->tanggal_mulai, $item->tanggal_selesai) }}k</h3>
