      ...
      <div class="settings-menu p-0">
         ...
         <div class="course-group mb-0 d-flex">
            <div class="course-group-img d-flex align-items-center">
               <a href="https://dreamslms.dreamguystech.com/laravel/public/instructor-profile"><img src="{{ asset('images/rental/') }}" alt="" class="img-fluid"></a>
            ...
            <div class="profile-share d-flex align-items-center justify-content-center">
               {{-- <a href="{{ url('admin/rental/'..'/detail/supir') }}" class="btn btn-outline-info m-2">Data Supir</a> --}}
         ...
         <div class="checkout-form personal-address add-course-info">
            ...
            <form action="{{ url('admin/rental/store') }}" method="POST" enctype="multipart/form-data">
                @csrf
